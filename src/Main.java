public class Main {
    public static void main(String[] args) {
        Admin admin = new Admin("Pan", "P");

        Employee e1 = new Employee("Pan", "P");
        Employee e2 = new Employee("Pan", "P");
        Employee e3 = new Employee("Pan", "P");
        Employee e4 = new Employee("Pan", "P");
        ...
        Client c1 = new Client("Pan", "P", b1);
        Client c2 = new Client("Pan", "P", b2);
        Client c3 = new Client("Pan", "P", b3);
        Client c4 = new Client("Pan", "P", b4);
        ...
        } catch (AccOperationsExceptions e) {
